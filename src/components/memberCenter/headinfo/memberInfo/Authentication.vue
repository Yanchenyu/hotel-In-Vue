...
<template>
  <div class="layout_div">
    ...
    <div style="margin:0 auto;max-width: 315px;padding: 0 30px;">
      <group gutter="0px">
        <x-input class="cus-normal vux-override register" style="margin-top:20px;font-size:16px;height: 59px" title='' keyboard="number"
      ...
      onClick () {
        ...
        fetchLoginByCodeAxios(params).then(response => {
          ...
          if (response.data.Success == true) {
            ...
            this.$router.push({name: 'changepassword', params: {status: this.$route.params.status, phone: this.phone}})  // 跳转设置密码页
          } else {
            // TODO 显示无查询数据
